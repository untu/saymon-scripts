...
# An example to cteate HW object with child SCRIPT-EXECUTION-probe subobject.
...
execName=curl # The name or path to the executable file
execArgs=saymon.info # The arg to pass to the executable file
...
# echo objectGroupID CREATED OBJECT ID - $objectGroupId # result for the previous command for some kind of debugging
	...
	# Executable file - curl - $execName
	# Argument - saymon.info - $execArgs
	apiMethod="node/api/objects" # SAYMON REST API method to use in a query
	queryURL="$serverURL/$apiMethod?api-token=$userAuthToken" # Generates URL for the query
	objectName="INFO - SCRIPT-EXEC-probe" # The NAME of our INFO object
	class_id=24 # The CLASS ID of our object; 24 is a INFO
	myJSON="{\"name\":\"$objectName\",\"parent_id\": \"$objectGroupId\",\"class_id\": \"$class_id\", \"properties\":[{\"name\": \"AgentId\",\"value\": \"$agent_id\",\"type_id\": \"8\"},{\"name\": \"TaskType\",\"value\": \"exec\",\"type_id\": \"8\"},{\"name\": \"ExecName\",\"value\": \"$execName\",\"type_id\": \"8\"},{\"name\": \"ExecArgs\",\"value\": \"[\\\"$execArgs\\\"]\",\"type_id\": \"8\"},{\"name\":\"TaskPeriodUnit\",\"value\": \"seconds\",\"type_id\": \"8\"},{\"name\": \"TaskPeriodValue\",\"value\": \"60\",\"type_id\": \"8\"}]}" # Generates data for the query
	# echo; echo myJSON QUERY - $myJSON; echo # result for the previous command for some kind of debugging
